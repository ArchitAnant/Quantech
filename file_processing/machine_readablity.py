...
def return_layout(file_path):
    ...
    for page_number in range(len(pdf_document)):
        ...
        for image_index, image in enumerate(images):
            ...
            width_points = width / dpi * 72
            height_points = height / dpi * 72
            ...
            height_list.append(height_points)
        ...
        if len(read_pdf(file_path))==0:
            ...
            for height in dim_list:
                if height>144:
                    ...
                    return False
    return True
print(is_machine_readable("/Users/architanant/Documents/Quantech/file_processing/test_files/test1.pdf"))
